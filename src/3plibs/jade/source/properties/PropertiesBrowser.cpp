...
PropertiesBrowser::PropertiesBrowser(QWidget* parent) : QScrollArea(parent)
{
	...
	registerDrawingWidget("Drawing", new RectPropertyWidget("sceneRect", "", true));
	...
	registerItemsWidget("Rect", new RectPropertyWidget("rect", "", false));
	registerItemsWidget("Rect", new SizePropertyWidget("cornerRadius", "Corner Radius"));
	registerItemsWidget("Ellipse", new RectPropertyWidget("ellipse", "", false));
